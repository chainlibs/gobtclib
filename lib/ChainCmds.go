...
func NewGetCFilterCmd(hash string, filterType FilterType) *GetCFilterCmd {
...
func NewGetCFilterHeaderCmd(hash string, filterType FilterType) *GetCFilterHeaderCmd {
